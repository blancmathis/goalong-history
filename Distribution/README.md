...
The September 2026 brand pass reuses the existing Goalong mark and the website forest/lime palette. Output pixel dimensions are explicit on both Retina and non-Retina hosts. Signing and notarization badges are not drawn into static artwork; release identity is described by actual build metadata.
