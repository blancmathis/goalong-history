    ...
    final class AppleScreenTimeDashboardModel: ObservableObject {
        ...
        private static func systemSharePayload(
            ...
            return AppleScreenTimeSharePayload(
                ...
                trustNotice: summary.provenance.usesAppleSettingsObservablePresentation
                    ? "These values were copied locally from the Apple Screen Time presentation visible in System Settings. Goalong did not recalculate the total, store a screenshot, or persist Apple’s usage database. The values prove visible parity at the recorded read time, not Apple’s inaccessible internal representation."
                    : "These values were read directly from Apple’s local knowledgeC, Biome, or private ScreenTimeAgent stores. They were not generated by Goalong History or manually imported. Apple’s private on-disk formats are not cryptographically attested for third parties and may change in future OS releases."
            )
        }
