...
final class GoalongWebsiteSharingRenderingTests: XCTestCase {
    @MainActor func testRenderSharingWindow() async throws {
        ...
        let payload = Data(#"{"version":2,"source":"goalong-history","days":[{"date":"2026-09-13","telemetry":{"devices":[{"id":"device-demo","name":"Ordinateur","screenSeconds":21600,"apps":[{"id":"vscode","name":"Visual Studio Code","seconds":7200}]}],"websites":null}}]}"#.utf8)
